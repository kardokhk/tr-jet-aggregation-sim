...
#SBATCH --job-name=duomax-grid
#SBATCH --output=logs/%x-%j.out
# Full pre-specified grid (protocol v01, config base v02). Run from the project root.
set -euo pipefail
OUT=${OUT:-results/2026-09-18_full}
CFG=code/configs/base.yaml
...
{ chunk E1 2304 24; chunk E2 1440 48; chunk E3 96 8; chunk E4 576 12; chunk E5 12 1; chunk E6 54 3; } > "$tasks"
